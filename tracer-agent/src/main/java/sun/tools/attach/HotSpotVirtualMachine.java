 ...
 * Modified: removed @jdk.Exported, removed AttachOperationFailedException/AttachNotSupportedException
 * imports not needed in this subclass (they're used only in LinuxVirtualMachine).
 */
